...
export default function Section7 () {
    return (
        <View style={{ flex : 1  ,margin : 20 , marginTop : 5 , borderWidth : 1 , borderColor : "white" , paddingBottom : 10 }}>
             <View>
                <Text style={{fontSize : 15}}>Room Type</Text>
            </View>
            <View style={{ flexDirection : "row", padding : 10}}> 
                <Image style={{width :60 , height : 60 , borderRadius : 40/3 }} source={require('../../assets/week3/room-8.jpg')} />
